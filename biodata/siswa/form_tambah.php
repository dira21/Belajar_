                        ...
                        <form action="proses_tambah.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="jur" id="">
                                    ...
                                    <?php
                                    //kode utk looping data jurusan
                                     include_once("../koneksi.php");
                                     $qry_jur = "SELECT * FROM jurusan";
                                     $data_jur = mysqli_query($koneksi,$qry_jur);
                                     foreach($data_jur as $item_jur){
                                    ?>
                                    <option value="<?= $item_jur['id'] ?>"><?= $item_jur['kode_jurusan'] ?> - <?= $item_jur['nama_jurusan'] ?></option>
                                    <?php 
                                    //end looping
                                    } 
                                    ?>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="gel" id="">
                                    ...
                                    ?>
                                    <option value="<?=$item_gel['id']?>"><?=$item_gel['nm_gelombang']?></option>
                                    <?php
